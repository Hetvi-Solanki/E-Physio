      ...
      <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                        ...
                        <li>
                              <a href="physiolist.php">Book appointment</a>
                        </li>
                        ...
                        <!-- <li class="dropdown">
                              ...
                              <ul class="dropdown-menu "  style="background-color: #48bdc5;">
                                    ...
                                    <li>
                                          <a href="viewtips.php">View Tips</a>
                                    </li>
                              <!-- </ul>
                        </li> -->
                        <!-- <li class="dropdown">
                              ...
                              <ul class="dropdown-menu "  style="background-color: #48bdc5;">
                                    ...
                                    <li>
                                          <a href="viewmedia.php">View Posts</a>
                                    </li>
                              <!-- </ul>
                        </li> -->
                        ...
                        <li>
                              <a href="patient_index_after_logout.php">Logout</a>
                        </li>
